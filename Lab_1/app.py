...
def not_found(e):
    return jsonify(message="You do not have access!", status=401)


@app.errorhandler(400)
def not_found(e):
    return jsonify(message="You do not have access!", status=400)
...
def add_user():
    ...
    if name == "" or email == "" or password == "" or stats_user == "" or count_of_messages == "":
...
def add_note():
    ...
    if name == "" or id_users == "" or count_of_users == "" or description == "":
        return "Invalid body", 400
...
def add_tag():
    ...
    if name == "" or id_note == "" or description == "":
        return "Invalid body", 400
    for tag in all_tags:
        if tag.name == name:
            return "Note with such name already exists", 409
...
def add_history():
    ...
    if name == "" or id_note == "" or id_users == "" or description == "" or time_of_edit == "":
        return "Invalid body", 400
